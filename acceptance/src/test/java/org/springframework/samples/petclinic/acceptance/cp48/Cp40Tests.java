...
/** cp40 membership-points: UPDATED by cp48 (fiscal-year) — Move date-derived values to a fiscal-year basis, where the fiscal year starts on 1 July */
@Tag("cp40")
class Cp40Tests extends AcceptanceBase {
	...
	void coreUpdatedBehaviour() throws Exception {
		...
		// TODO: assert the UPDATED behaviour of "membership-points" under the new spec.
